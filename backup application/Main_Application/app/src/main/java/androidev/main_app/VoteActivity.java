        ...
        vote_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkedButton == null){
                    ...
                    Toast.makeText(getApplicationContext(), "Please select an option to vote", Toast.LENGTH_SHORT).show();
                }else {
                    ...
                    if (db.CheckVote(question_id_str, user_id_str) == true){
                        Toast.makeText(VoteActivity.this, "You have already voted on this questions. Please try another question!", Toast.LENGTH_LONG).show();
                        ...
                        db.Vote(Integer.parseInt(question_id_str),checkedButton, Integer.parseInt(user_id_str),Integer.parseInt(poll_id_str));
