...
public class QuestionListAdapter extends ArrayAdapter<QuestionsModel> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        //find the checkedTick imageView from the layout file
        ...
        //check if the public votes_list from the VoteActivity class contains the current questionID
        if (VoteActivity.votes_list.contains(questionID)){
            //for every question id in the list, set the imageView to Invisible
