...
public class AdminLoginFragment extends Fragment  {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        //The fragment_admin_login layout is inflated into the view.
        ...
        //Constructor is used to created an instance object for the database helper class
        ...
        login_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (email.getText().toString().equals("")||password.getText().toString().equals("")){
                    ...
                    Boolean adminCheckEmailPassword = db.adminCheckEmailPassword(email.getText().
